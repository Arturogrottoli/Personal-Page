...
"Uso VS Code, GitHub, Jira, y constantemente pruebo herramientas nuevas a medida que surgen. Las evalúo, las pruebo en proyectos propios y, si me dan resultado, las incorporo a mi flujo. Me interesa especialmente todo lo relacionado con IA aplicada al desarrollo."
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Si falta la key en Vercel, devolvemos un error genérico (sin mensajes internos).
    if (!GROQ_API_KEY) {
